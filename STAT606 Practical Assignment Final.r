...
library(readr)
iportal_downtimes_emea <- read_csv("UKZN DATA SCIENCE/606 ML assignment/iportal downtimes emea.csv")
...
# 1.2 Decision Tree model (implemented using rpart, for  further analysis of tree growth Rpart was applied without any hyperparameter values)
...
DT_rpart <- rpart(
  ...
  #CP = 0.03, # complexity parameter for pruning 
  #minsplit = 20, # min observations to attempt a spit
  maxdepth = 4 # maximum depth 
)
)
DT_rpart #to see information about the fitted tree
